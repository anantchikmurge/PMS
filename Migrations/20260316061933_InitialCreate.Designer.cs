...
namespace PharmacyManagementSystem.Migrations
{
    ...
    [Migration("20260316061933_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmacyManagementSystem.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PharmacyManagementSystem.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PharmacyManagementSystem.Models.OrderItem", b =>
                {
                    b.HasOne("PharmacyManagementSystem.Models.Order", null)
                        .WithMany("Items")
